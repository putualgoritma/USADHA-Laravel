...
<div class="card">
    <div class="card-header">
        {{ trans('global.create') }} {{ trans('global.member.title_singular') }}
    </div>
    ...
    <div class="card-body">
        <form action="{{ route("admin.members.store") }}" method="POST" enctype="multipart/form-data">
            ...
            <div class="form-group {{ $errors->has('register') ? 'has-error' : '' }}">
                ...
                <input type="date" id="register" name="register" class="form-control" value="{{ old('register', isset($production) ? $production->register : '') }}" required>
            ...
            <div class="form-group {{ $errors->has('package_id') ? 'has-error' : '' }}">
                ...
                <select name="package_id" class="form-control">
                    ...
                    @foreach ($products as $product)
                        <option value="{{ $product->id }}"{{ old('package_id') == $product->id ? ' selected' : '' }}>
                        {{ $product->name }}
                        </option>
                    @endforeach
                </select>
            ...
            <div class="form-group {{ $errors->has('agents_id') ? 'has-error' : '' }}">
                ...
                <select name="agents_id" class="form-control">
                    ...
                    @foreach ($agents as $agent)
                        <option value="{{ $agent->id }}"{{ old('code') == $agent->id ? ' selected' : '' }}>
