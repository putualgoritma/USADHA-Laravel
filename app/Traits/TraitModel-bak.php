...
trait TraitModel
{
    // public function test_activation_type()
    // {
    //     //list member active
    ...
    //             if($member->id!=$order->customers_activation_id){
    //             echo $member->id . " || " .  $order->id . " - " .  $order->customers_activation_id . "<br>";
    //             }
    //         } else {
    ...
    //             $order->customers_activation_id = $member->id;
    //             $order->type = 'activation_member';
    //             $order->save();
    ...
    // public function auto_oldactivation_type()
    // {
    //     //list member active
    //     $members_list = Customer::select('id', 'code', 'created_at')
    //         ->where('status', '=', 'active')
